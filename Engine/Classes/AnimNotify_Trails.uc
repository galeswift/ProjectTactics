...
// @todo ib2merge: Chair added this fields, with this comment: added to make editor life easier with our dynamic system
/** If TRUE, this will be previewed as a big attack (using the AnimNotify_FX_Preview section in ini based on pawn's FXSwordTrailBig variable) */
//var() editoronly bool bPreviewBigAttack;
...
defaultproperties
{
	...
	LastStartTime=0.0f
	// @todo ib2merge: Chair had set this to 120.0
	SamplesPerSecond=60
	...
	// @todo ib2merge: Chair has set these values
	// PSTemplate=ParticleSystem'B_FX_Magic.Items.MoveTrail01'
	// bPreview=true
	// FirstEdgeSocketName=RSword_Bottom
	// SecondEdgeSocketName=RSword_Top
	// ControlPointSocketName=RSword_Control
